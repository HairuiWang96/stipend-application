    ...
    try {
      const response = await fetch("/api/applications", {
        ...
        headers: {
          ...
          "X-API-Key": process.env.NEXT_PUBLIC_API_KEY || "stipend-api-key-2024",
        },
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <fieldset className="border p-4 rounded">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            />
            {errors.programName && (
              <p className="text-red-600 text-sm mt-1">{errors.programName.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.amountRequested && (
              <p className="text-red-600 text-sm mt-1">{errors.amountRequested.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="mt-4">
          <label className="flex items-start gap-2">
            ...
            <span className="text-sm">
              I agree to the terms and conditions of this stipend application.
              I certify that all information provided is accurate and complete. *
            </span>
          </label>
          {errors.agreementAccepted && (
            <p className="text-red-600 text-sm mt-1">{errors.agreementAccepted.message}</p>
          )}
        </div>
      </fieldset>
      ...
      <button
        ...
        className="w-full bg-blue-600 text-white py-3 px-4 rounded font-medium hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed"
      >
